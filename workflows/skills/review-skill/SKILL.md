...
2. Use `anti-slop-review` to audit the recent diff for broader slop patterns:
   weak task contracts, dead code, docs drift, robustness gaps, security
   footguns, weak tests, architectural drift, guidance overlap, and
