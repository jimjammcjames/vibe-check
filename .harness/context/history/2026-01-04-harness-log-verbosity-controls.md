...
related:
  - "[Stub Provider Key Collision Fix](.harness/context/history/2026-01-04-stub-provider-key-collision.md)"
  - "[Worktree Cleanup](.harness/context/history/2026-01-04-orphaned-worktree-cleanup.md)"
tags:
  - "#harness-meta"
  - "#developer-experience"
  - "#logging"
