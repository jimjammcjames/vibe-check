...
describe("minimatch", () => {
  ...
  describe("directory patterns", () => {
    it("matches src/**/*.ts pattern", () => {
      ...
      assert.strictEqual(
        minimatch("src/utils/helpers.ts", "src/**/*.ts"),
        true,
      );
  ...
  describe("file extension patterns", () => {
    ...
    it("matches test file patterns", () => {
      ...
      assert.strictEqual(
        minimatch("src/utils/foo.test.ts", "**/*.test.ts"),
        true,
      );
    ...
    it("matches __tests__ directory pattern", () => {
      assert.strictEqual(
        minimatch("src/__tests__/foo.ts", "**/__tests__/**"),
        true,
      );
      assert.strictEqual(
        minimatch("__tests__/bar.js", "**/__tests__/**"),
        true,
      );
    });
  });
